...
/**
 * @file plugins/generic/objectsForReview/ObjectForReviewOrganizationForm.inc.php
 *
 * Copyright (c) 2013-2014 Simon Fraser University Library
 * Copyright (c) 2003-2014 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class ObjectForReviewOrganizationForm
 * @ingroup plugins_generic_objectsForReview
 *
 * @brief Form for journal managers to modify Object for Review Organization entries
 */


import('lib.pkp.classes.form.Form');

class ObjectForReviewOrganizationForm extends Form {
	 ...
	 */
	function ObjectForReviewOrganizationForm(&$plugin, $journalId, $organizationId = 0) {
		...
		if ($organizationId) {
			$bfrOrgId = DAORegistry::getDAO('ObjectForReviewOrganizationDAO');
