...
define('REVIEW_OBJECT_METADATA_TYPE_REVIEWER_PDF', 			0x000010);
define('REVIEW_OBJECT_METADATA_TYPE_PUBLISHER_ID_DROP_DOWN_BOX',	0x000011);
...
define('REVIEW_OBJECT_METADATA_KEY_PUBLISHER',		'publisherId');
...
define('REVIEW_OBJECT_METADATA_KEY_REVIEWER_PDF',	'reviewerPDF');
...
class ReviewObjectMetadata extends DataObject {
	...
	function &getMetadataDTDTypes() {
		static $metadataDTDTypes =  array(
			...
			'publisherIdDropDownBox' => REVIEW_OBJECT_METADATA_TYPE_PUBLISHER_ID_DROP_DOWN_BOX,
			'coverPage' => REVIEW_OBJECT_METADATA_TYPE_COVERPAGE,
			'reviewerPDF' => REVIEW_OBJECT_METADATA_TYPE_REVIEWER_PDF
	...
	function &getCommonMetadataKeys() {
		static $commonMetadataKeys = array(
			...
			REVIEW_OBJECT_METADATA_KEY_PUBLISHER,
			...
			REVIEW_OBJECT_METADATA_KEY_REVIEWER_PDF
		);
